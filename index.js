...
console.log(startColor('Iniciando el proyecto, espere un momento..'));
...
cfonts.say('SheraBot-MD'.trim(), options)

} catch (err) {
say('SheraBot-MD', { //Nombre de tu bot.
 font: '3d',
 align: 'center',
